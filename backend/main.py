            ...
            httpx.post("https://api.resend.com/emails",
                ...
                json={
                    ...
                    <div style="background:#fff;padding:20px;border:1px solid #e5e7eb;border-radius:0 0 8px 8px">
                        ...
                        <a href="https://sentiapp.duckdns.org/signup" style="background:#7C3AED;color:white;padding:10px 20px;border-radius:6px;text-decoration:none;display:inline-block;margin:15px 0">Accept invitation</a>
